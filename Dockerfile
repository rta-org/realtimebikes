...
RUN pip install --no-cache-dir --upgrade pip setuptools wheel && \
    ...
    pip install --no-cache-dir ipywidgets==8.1.1 flask==3.0.1 fastapi==0.115.5 pydantic"<2.0" uvicorn[standard]==0.32.0 pydot==2.0.0 && \
    ...
    pip install --no-cache-dir streamlit==1.32.2 folium==0.16.0 streamlit-folium==0.18.0 plotly==5.20.0
...
RUN wget https://archive.apache.org/dist/kafka/3.7.1/kafka_2.12-3.7.1.tgz && \
    ...
    rm -f /home/jovyan/kafka_2.12-3.7.1.tgz && \
    rm -rf /home/jovyan/kafka/bin/windows/ /home/jovyan/kafka/licenses /home/jovyan/kafka/site-docs /home/jovyan/kafka/NOTICE /home/jovyan/kafka/LICENSE && \
    rm -f /home/jovyan/kafka/bin/*server*.sh

# fix-permissions is a script provided by Jupyter base images to set ownership correctly.
